(function () {
  ...
  let THRESHOLD = 20.0; // remove matches with a distance higher than this
  let MAX_RESULTS = 12; // number of results to show, don't change this for now
  ...
  /* node_modules/svelte-tabs/src/Tabs.svelte generated by Svelte v3.59.2 */
  ...
  function instance$7($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
      if ("initialSelectedIndex" in $$props)
        $$invalidate(2, (initialSelectedIndex = $$props.initialSelectedIndex));
  ...
  /* node_modules/svelte-tabs/src/Tab.svelte generated by Svelte v3.59.2 */
    ...
    const block = {
      ...
      p: function update(ctx, [dirty]) {
        ...
        if (
          !current ||
          (dirty & /*$controls*/ 4 &&
            li_aria_controls_value !==
              (li_aria_controls_value =
                /*$controls*/ ctx[2][/*tab*/ ctx[3].id]))
        ) {
  ...
  function instance$6($$self, $$props, $$invalidate) {
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("isSelected" in $$props)
        $$invalidate(1, (isSelected = $$props.isSelected));
    };
  ...
  /* node_modules/svelte-tabs/src/TabList.svelte generated by Svelte v3.59.2 */
  ...
  /* node_modules/svelte-tabs/src/TabPanel.svelte generated by Svelte v3.59.2 */
  ...
  function create_fragment$4(ctx) {
    ...
    let current;
    let if_block =
      /*$selectedPanel*/ ctx[1] === /*panel*/ ctx[2] && create_if_block$1(ctx);
  ...
  const file$3 = "src/Match.svelte";

  function get_each_context$1(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[10] = list[i];
    child_ctx[13] = i;
    const constants_0 = /*face*/ child_ctx[10].performers;
  ...
  function create_if_block(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        button1.textContent = "Toggle Visibility";
        attr_dev(div0, "class", "modal-body svelte-ssoxzi");
        add_location(div0, file$3, 137, 8, 3599);
        attr_dev(button0, "id", "face_close");
        attr_dev(button0, "type", "button");
        attr_dev(button0, "class", "ml-2 btn btn-secondary svelte-ssoxzi");
        add_location(button0, file$3, 202, 12, 6147);
        attr_dev(button1, "id", "face_toggle");
        attr_dev(button1, "type", "button");
        attr_dev(button1, "class", "ml-2 btn btn-secondary svelte-ssoxzi");
        add_location(button1, file$3, 208, 12, 6329);
        attr_dev(div1, "class", "svelte-ssoxzi");
        add_location(div1, file$3, 201, 10, 6129);
        attr_dev(div2, "class", "ModalFooter modal-footer svelte-ssoxzi");
        add_location(div2, file$3, 200, 8, 6080);
        attr_dev(div3, "class", "modal-content svelte-ssoxzi");
        add_location(div3, file$3, 136, 6, 3563);
        attr_dev(div4, "class", "modal-dialog modal-xl svelte-ssoxzi");
        add_location(div4, file$3, 135, 4, 3521);
        attr_dev(div5, "role", "dialog");
        attr_dev(div5, "aria-modal", "true");
        attr_dev(div5, "class", "fade ModalComponent modal show svelte-ssoxzi");
        attr_dev(div5, "tabindex", "-1");
        set_style(div5, "display", "block");
        add_location(div5, file$3, 125, 2, 3278);
      },
      m: function mount(target, anchor) {
  ...
  function create_default_slot_3(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(img, "alt", "");
        attr_dev(img, "class", "face-tab svelte-ssoxzi");
        add_location(img, file$3, 142, 18, 3757);
      },
      m: function mount(target, anchor) {
  ...
  // (141:14) {#each matches as face, i (face.image)}
  function create_each_block_2(key_1, ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(141:14) {#each matches as face, i (face.image)}",
      ctx,
    });
  ...
  function create_default_slot_2(ctx) {
    ...
    let each_1_anchor;
    let current;
    let each_value_2 = /*matches*/ ctx[0];
    validate_each_argument(each_value_2);
    const get_key = (ctx) => /*face*/ ctx[10].image;
  ...
  // (157:20) {#each performers as match, i (match.id)}
  function create_each_block_1(key_1, ctx) {
    ...
    let div2;
    let a;
    let t2_value = /*match*/ ctx[14].name + "";
    let t2;
    let a_href_value;
    let t3;
    let span1;
    let div1;
    let t4_value = /*match*/ ctx[14].confidence + "";
    let t4;
    let t5;
    let t6;
    let div4_id_value;
    ...
    function click_handler(...args) {
      return /*click_handler*/ ctx[6](/*match*/ ctx[14], ...args);
    }

    function keypress_handler(...args) {
      return /*keypress_handler*/ ctx[7](/*match*/ ctx[14], ...args);
    }
    ...
    const block = {
      ...
      c: function create() {
        ...
        t5 = text("%");
        t6 = space();
        attr_dev(img, "class", "performer-card-image svelte-ssoxzi");
        attr_dev(img, "alt", (img_alt_value = /*match*/ ctx[14].name));
        if (!src_url_equal(img.src, (img_src_value = /*match*/ ctx[14].image)))
          attr_dev(img, "src", img_src_value);
        add_location(img, file$3, 167, 26, 4739);
        attr_dev(
          span0,
          "class",
          (span0_class_value =
        ...
        add_location(div0, file$3, 166, 24, 4681);
        attr_dev(
          a,
          "href",
          (a_href_value =
        ...
        add_location(a, file$3, 180, 30, 5374);
        attr_dev(div1, "class", "svelte-ssoxzi");
        add_location(div1, file$3, 187, 33, 5721);
        attr_dev(span1, "class", "tag-item badge badge-pill svelte-ssoxzi");
        add_location(span1, file$3, 186, 30, 5648);
        set_style(div2, "-webkit-line-clamp", "2");
        attr_dev(div2, "class", "svelte-ssoxzi");
        add_location(div2, file$3, 179, 28, 5308);
        attr_dev(h5, "class", "card-section-title flex-aligned svelte-ssoxzi");
        add_location(h5, file$3, 178, 26, 5235);
        attr_dev(div3, "class", "card-section svelte-ssoxzi");
        add_location(div3, file$3, 177, 24, 5182);
        attr_dev(div4, "draggable", "false");
        attr_dev(div4, "class", "performer-card grid-card card svelte-ssoxzi");
        attr_dev(div4, "id", (div4_id_value = "face-" + /*i*/ ctx[13]));
        add_location(div4, file$3, 157, 22, 4265);
        this.first = div4;
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = [
            action_destroyer(smoothload.call(null, img)),
            listen_dev(
              div4,
              "click",
              click_handler,
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (
          dirty & /*matches*/ 1 &&
          img_alt_value !== (img_alt_value = /*match*/ ctx[14].name)
        ) {
        ...
        if (
          dirty & /*matches*/ 1 &&
          !src_url_equal(img.src, (img_src_value = /*match*/ ctx[14].image))
        ) {
          attr_dev(img, "src", img_src_value);
        }
        ...
        if (
          dirty & /*matches*/ 1 &&
          t2_value !== (t2_value = /*match*/ ctx[14].name + "")
        )
        ...
        if (
          dirty & /*matches*/ 1 &&
          t4_value !== (t4_value = /*match*/ ctx[14].confidence + "")
        )
          set_data_dev(t4, t4_value);

        if (
          dirty & /*matches*/ 1 &&
          div4_id_value !== (div4_id_value = "face-" + /*i*/ ctx[13])
        ) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(157:20) {#each performers as match, i (match.id)}",
      ctx,
    });
  ...
  function create_default_slot_1(ctx) {
    ...
    let each_1_lookup = new Map();
    let t;
    let each_value_1 = /*performers*/ ctx[11];
    ...
    const block = {
      c: function create() {
        ...
        t = space();
        attr_dev(div0, "class", "carousel svelte-ssoxzi");
        add_location(div0, file$3, 155, 18, 4158);
        attr_dev(div1, "class", "row svelte-ssoxzi");
        add_location(div1, file$3, 154, 16, 4122);
      },
      m: function mount(target, anchor) {
      ...
      p: function update(ctx, dirty) {
        if (dirty & /*matches, addPerformer*/ 33) {
          each_value_1 = /*performers*/ ctx[11];
          validate_each_argument(each_value_1);
          validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
          each_blocks = update_keyed_each(
            each_blocks,
  ...
  // (152:12) {#each matches as face, i (face.image)}
  function create_each_block$1(key_1, ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(152:12) {#each matches as face, i (face.image)}",
      ctx,
    });
  ...
  function instance$3($$self, $$props, $$invalidate) {
    ...
    async function addPerformer(current, id_) {
      ...
      if (performers.length === 0) {
        ...
        performer.stash_ids = [{ endpoint, stash_id: id_ }];
    ...
    Object_1.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<Match> was created with unknown prop '${key}'`);
    });

    const click_handler = (match, event) =>
      addPerformer(event.target, match.id);
    const keypress_handler = (match, event) =>
      addPerformer(event.target, match.id);
    ...
    $$self.$inject_state = ($$props) => {
      if ("matches" in $$props) $$invalidate(0, (matches = $$props.matches));
      if ("matchesSelected" in $$props)
        matchesSelected = $$props.matchesSelected;
  ...
  /* src/SearchFaces.svelte generated by Svelte v3.59.2 */

  const { console: console_1 } = globals;
  const file$2 = "src/SearchFaces.svelte";
  ...
  function create_fragment$2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(svg, file$2, 65, 2, 1733);
        attr_dev(button, "id", "visage");
        attr_dev(button, "class", "svelte-1m5gxnd");
        toggle_class(button, "scanner", /*scanner*/ ctx[0]);
        add_location(button, file$2, 64, 0, 1675);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
  ...
  function instance$2($$self, $$props, $$invalidate) {
    let { $$slots: slots = {}, $$scope } = $$props;
    validate_slots("SearchFaces", slots, []);
    let scanner = false;
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console_1.warn(`<SearchFaces> was created with unknown prop '${key}'`);
    });
  ...
  class SearchFaces extends SvelteComponentDev {
    constructor(options) {
      super(options);
  ...
  /* src/Faces.svelte generated by Svelte v3.59.2 */
  const file$1 = "src/Faces.svelte";
  ...
  // (49:10) {#each frames as frame (frame.id)}
  function create_each_block(key_1, ctx) {
    ...
    function click_handler() {
      return /*click_handler*/ ctx[8](/*frame*/ ctx[10]);
    }
    ...
    const block = {
      ...
      c: function create() {
        ...
        div0 = element("div");
        t = space();
        attr_dev(div0, "class", "face-item svelte-p95y28");
        set_style(
          div0,
          "background-position",
          "-" +
        ...
        add_location(div1, file$1, 55, 14, 1513);
        attr_dev(div2, "class", "svelte-p95y28");
        toggle_class(
          div2,
          "selected",
      ...
      p: function update(new_ctx, dirty) {
        ...
        if (!current || dirty & /*selected, frames*/ 10) {
          toggle_class(
            div2,
            "selected",
            /*selected*/ ctx[3] === /*frame*/ ctx[10].id
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(49:10) {#each frames as frame (frame.id)}",
      ctx,
    });
  ...
  function create_fragment$1(ctx) {
    ...
    function searchfaces_calls_binding(value) {
      /*searchfaces_calls_binding*/ ctx[7](value);
    }

    let searchfaces_props = {};

    if (/*calls*/ ctx[4] !== void 0) {
      searchfaces_props.calls = /*calls*/ ctx[4];
    }
    ...
    validate_each_argument(each_value);
    const get_key = (ctx) => /*frame*/ ctx[10].id;
    ...
    const block = {
      c: function create() {
        ...
        div1 = element("div");
        div0 = element("div");
        create_component(searchfaces.$$.fragment);
        t0 = space();
        button = element("button");
        ...
        attr_dev(button, "id", "tags-cancel");
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "ml-2 btn btn-secondary");
        add_location(button, file$1, 38, 10, 991);
        add_location(div0, file$1, 36, 8, 931);
        attr_dev(div1, "class", "ModalFooter modal-header");
        add_location(div1, file$1, 35, 6, 884);
        attr_dev(div2, "class", "row justify-content-center");
        add_location(div2, file$1, 47, 8, 1219);
        attr_dev(div3, "class", "modal-body");
        add_location(div3, file$1, 46, 6, 1186);
        attr_dev(div4, "class", "modal-content");
        add_location(div4, file$1, 34, 4, 850);
        attr_dev(div5, "class", "modal-dialog modal-xl top-accent");
        add_location(div5, file$1, 33, 2, 799);
        attr_dev(div6, "class", "face-tabs svelte-p95y28");
        add_location(div6, file$1, 32, 0, 756);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
      ...
      m: function mount(target, anchor) {
        ...
        append_dev(div1, div0);
        mount_component(searchfaces, div0, null);
        append_dev(div0, t0);
      ...
      p: function update(ctx, [dirty]) {
        const searchfaces_changes = {};

        if (!updating_calls && dirty & /*calls*/ 16) {
          updating_calls = true;
          searchfaces_changes.calls = /*calls*/ ctx[4];
          add_flush_callback(() => (updating_calls = false));
        }

        searchfaces.$set(searchfaces_changes);

        if (dirty & /*selected, frames, url, select*/ 75) {
          each_value = /*frames*/ ctx[1];
          validate_each_argument(each_value);
          group_outros();
      ...
      i: function intro(local) {
        if (current) return;
        transition_in(searchfaces.$$.fragment, local);
      ...
      o: function outro(local) {
        transition_out(searchfaces.$$.fragment, local);
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    const writable_props = ["url", "frames"];
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<Faces> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$$set = ($$props) => {
      ...
      if ("frames" in $$props) $$invalidate(1, (frames = $$props.frames));
    };
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("calls" in $$props) $$invalidate(4, (calls = $$props.calls));
    };
    ...
    return [
      ...
      close,
      select,
      searchfaces_calls_binding,
      click_handler,
      div6_binding,
    ];
  }

  class Faces extends SvelteComponentDev {
    constructor(options) {
      super(options);
  ...
  /* src/FindFaces.svelte generated by Svelte v3.59.2 */
  const file = "src/FindFaces.svelte";
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(svg, "viewBox", "0 0 24 24");
        attr_dev(svg, "class", "svelte-1m5gxnd");
        add_location(svg, file, 64, 2, 2067);
        attr_dev(button, "id", "faces");
        attr_dev(button, "class", "svelte-1m5gxnd");
        toggle_class(button, "scanner", /*scanner*/ ctx[0]);
        add_location(button, file, 63, 0, 2011);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
  ...
  function instance($$self, $$props, $$invalidate) {
    let { $$slots: slots = {}, $$scope } = $$props;
    validate_slots("FindFaces", slots, []);
    let scanner = false;
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<FindFaces> was created with unknown prop '${key}'`);
    });
    ...
    return [scanner, getFaces];
  }

  class FindFaces extends SvelteComponentDev {
    constructor(options) {
      super(options);
